...
var FacebookUtil = function(oauthRedirectURL, logoutRedirectURL) {
	DebugUtil.log("FacebookUtil", "initialize", oauthRedirectURL, logoutRedirectURL);
    ...
    function login(callback, options) {
    	DebugUtil.log("FacebookUtil", "login();", options);
    ...
    function oauthCallback(url) {
    	DebugUtil.log("FacebookUtil", "oauthCallback();", url);
    ...
    function logout(callback) {
    	DebugUtil.log("FacebookUtil", "logout();");
